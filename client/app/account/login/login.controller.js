...
angular.module('emarket').controller('LoginCtrl', function($scope, $rootScope, Auth, $location, $window, dialogs, $stateParams) {
  $scope.user = {};
  $scope.errors = {};
...
angular.module('emarket').controller('ForgotPasswordDialogCtrl', function($scope, $modalInstance, User, logSwal) {
...
angular.module('emarket').controller('LoginApiKeyCtrl', function($scope, $rootScope, $stateParams, Auth, $location, $state, logSwal) {
  $scope.user = {};
  $scope.errors = {};
