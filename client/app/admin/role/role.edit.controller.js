...
angular.module('emarket').controller('AdminRoleEditCtrl', function($scope, Message, $state, $stateParams, Role, dialogs) {
  $scope.role = {
    active: true,
    isShare: false
  };
...
angular.module('emarket').controller('AdminSelectPresetDialogCtrl', function($scope, Role, Message, $modalInstance) {
  Role.defaults(function(result) {
